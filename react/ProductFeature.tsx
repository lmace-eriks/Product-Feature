...
const ProductFeature: StorefrontFunctionComponent<ProductFeatureProps> = ({ title, image, shopButtonLink, moreButtonText, moreButtonLink, children }) => {
  const [openGate, setOpenGate] = useState<Boolean>(true);
  const closeButtonText = "Close";
  const classPrefix: string = "eriksbikeshop-productfeature-1-x-";
